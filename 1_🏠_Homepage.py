...
l4,r4=st.columns(2)
with l4:
    st.markdown("# The final Web Application!:computer:")
    st.write("Performing all the above steps in sequence and using the required Dependencies, we made it to the final Product ready for the deployment.")
with r4:
